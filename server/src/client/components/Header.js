    ...
    <div className="c-nav__brand" aria-label="Logo">
        <div className="c-logo__logo">
            <a href="/ymh">
                ...
                <div className="c-logo__fallback"></div>
            </a>
        </div>
    </div>
    <div className="c-nav__link-group--left">
        <a className="c-nav__link" href="http://dev.content.co/projects" aria-label="Projects">
            <p className="c-nav__link-text">Projects</p>
        </a>
    </div>
    <div className="c-nav__link-group--left">
        <div className="c-nav__link" aria-label="Portfolio">
            <div className="c-nav__link-text"><a href="/ymh">Portfolio</a></div>
        </div>
    </div>
    <div className="c-nav__link-group--left">
        <div className="c-nav__link">
            <div className="c-nav__link-text"><a href="/ratings">Reviews</a></div>
        </div>
    </div>
    <div className="c-nav__link-group c-nav__link-group--right">
        <a className="c-nav__link c-nav__link--square" href="/guide">
            <svg className="i-guide" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" icon-guide="">
                <path id="guide" fill="#020303" fillRule="nonzero" d="M19.13 3.57a1 1 0 0 1 1.37.93v13a1 1 0 0 1-.63.93l-5 2a1 1 0 0 1-.74 0L9.5 18.58l-4.63 1.85a1 1 0 0 1-1.37-.93v-13a1 1 0 0 1 .63-.93l5-2a1 1 0 0 1 .74 0l4.63 1.85 4.63-1.85zM5.5 18.02l3-1.2V5.98l-3 1.2v10.84zm8-10.84l-3-1.2v10.84l3 1.2V7.18zm2 10.84l3-1.2V5.98l-3 1.2v10.84z"></path>
            </svg>
        </a>
        <div className="g-dropdown ">
            <div className="c-nav__link-group">
                <div className="c-nav__link c-nav__link--square" aria-label="View profile">
                    <div className="g-text__row">
                        <img className="c-nav__link-image" src="https://devcdn.content.co/users/71/i/1519140563.15/closure.jpeg" alt="" />
                        <p className="c-nav__link-text c-nav__name">Ye Min H (Writer ACC)</p>
                    </div>
                </div>
            </div>
            <div className="g-dropdown__menu c-nav__menu">
                <div role="menu">
                    <a className="c-menu__link--settings" href="/settings/user">
                        <div className="c-menu__image--settings i-settings">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <path fill="none" fillRule="evenodd" stroke="#020303" strokeWidth="1.75" d="M6.31 7.94a1.09 1.09 0 0 1-.1-.19l-.08-.18a1.7 1.7 0 0 1 2.49-2.1l.16.12c.07.04.12.09.17.14.42-.2.87-.37 1.33-.49 0-.07.02-.14.04-.2l.06-.2a1.7 1.7 0 0 1 3.24 0l.06.2c.02.06.04.13.04.2.46.12.9.28 1.33.49.05-.06.1-.1.17-.14l.16-.11a1.7 1.7 0 0 1 2.5 2.09l-.09.18a1.1 1.1 0 0 1-.1.2 7 7 0 0 1 .7 1.21h.22l.2.03a1.7 1.7 0 0 1 .56 3.2l-.18.09a1.1 1.1 0 0 1-.2.08c-.04.47-.12.94-.24 1.38l.16.15.14.14a1.7 1.7 0 0 1-1.63 2.81l-.2-.04a1.1 1.1 0 0 1-.2-.07c-.33.33-.69.64-1.08.9l.04.22v.2a1.7 1.7 0 0 1-3.04 1.11l-.12-.16a1.1 1.1 0 0 1-.12-.19 7.1 7.1 0 0 1-1.4 0c-.03.07-.07.13-.12.19l-.12.16a1.7 1.7 0 0 1-3.05-1.11l.01-.2c0-.08.02-.15.04-.22a7.04 7.04 0 0 1-1.08-.9l-.2.07-.2.04a1.7 1.7 0 0 1-1.63-2.8l.14-.15.16-.15c-.12-.44-.2-.9-.24-1.38a1.09 1.09 0 0 1-.2-.08l-.18-.1a1.7 1.7 0 0 1 .56-3.2l.2-.02h.22a7 7 0 0 1 .7-1.22zM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"></path>
                            </svg>
                        </div>
                        <p className="c-menu__text--primary">Settings</p>
                    </a>
                    <span className="c-menu__link--settings">
                        <div className="c-menu__image--settings i-help">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <g fill="none" fillRule="evenodd" transform="rotate(45 12.85 11.65)">
                                    <circle cx="12.57" cy="12.5" r="8.69" stroke="#020303" strokeWidth="2" transform="rotate(45 12.57 12.5)"></circle>
                                    <path fill="#020303" fillRule="nonzero" d="M8.75 5.89c-.41-.46-1.1-.48-1.53-.04L5.9 7.15c-.44.44-.42 1.12.04 1.53l3.02 2.69a2.8 2.8 0 0 1 2.46-2.46L8.75 5.89zM16.17 11.36l3.01-2.68c.46-.41.48-1.1.04-1.53l-1.3-1.3a1.04 1.04 0 0 0-1.53.04L13.7 8.9a2.8 2.8 0 0 1 2.46 2.46zM8.97 13.64l-3.02 2.68c-.46.4-.48 1.1-.04 1.53l1.3 1.3c.44.44 1.12.42 1.54-.04l2.68-3.01a2.8 2.8 0 0 1-2.46-2.46zM13.7 16.1l2.69 3.01c.41.47 1.1.48 1.53.05l1.3-1.31c.44-.44.42-1.12-.04-1.53l-3.01-2.68a2.8 2.8 0 0 1-2.46 2.46z"></path>
                                    <circle cx="12.44" cy="12.37" r="4.5" stroke="#020303" strokeWidth="2" transform="rotate(45 12.44 12.37)"></circle>
                                </g>
                            </svg>
                        </div>
                        <p className="c-menu__text--primary">Help</p>
                    </span>
                    <a className="c-menu__link--settings">
                        <div className="c-menu__image--settings i-logout">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <g fill="#020303" fillRule="nonzero">
                                    <path d="M16.38 9.09a.75.75 0 1 1 .94-1.17l3.25 3.45c.36.3.37.85 0 1.15l-3.24 3.55a.75.75 0 1 1-.96-1.15l2.54-2.96-2.53-2.87z"></path>
                                    <path d="M10.7 12.75h8.72c.35 0 .64-.34.64-.75s-.29-.75-.64-.75H10.7c-.35 0-.64.34-.64.75s.29.75.64.75z"></path>
                                    <path d="M13.19 17.7l-.01-.76c0-.5.4-.9.9-.9.5-.01.9.39.91.88a47 47 0 0 1 0 1.7.9.9 0 0 1-.9.88H5.9a.9.9 0 0 1-.91-.9V5.4c0-.5.4-.9.9-.9h8.07c.5 0 .9.4.9.9v1.67a.9.9 0 1 1-1.81 0V6.3H6.81v11.4h6.38z"></path>
                                </g>
                            </svg>
                        </div>
